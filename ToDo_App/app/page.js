...
const page = () => {
    ...
    renderTask = mainTask.map((t,i)=>{
      return(
        <li key = {i} className="flex items-center justify-between mb-8">
          ...
          className={`${t.completed ? 'bg-green-500' : 'bg-blue-400'} text-white px-4 py-2 rounded font-bold`}
  ...
  return (
    <>
    <h1 className='bg-black text-white p-5 text-5xl font-bold text-center'>Juhi's Todo List</h1>
